  ...
  return (
    <div className="container py-6 md:py-8 lg:py-10 space-y-4 md:space-y-6 lg:space-y-8">
        <div>
          ...
          <p className="text-sm md:text-base text-muted-foreground mt-2">{s.quizDescription}</p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3">
          <button
            onClick={() => navigate("/quiz/all")}
            className="rounded-lg border border-primary/30 bg-card p-3 md:p-4 hover:border-primary hover:shadow-md transition-all text-left group"
          >
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className="rounded-lg border border-border bg-card p-3 md:p-4 hover:border-primary/50 hover:shadow-md transition-all text-left group"
              >
